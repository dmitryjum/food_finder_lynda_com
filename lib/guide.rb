...
def get_action
 ...
 def list(args=[])
 	...
 	sort_order = "name" unless ['name', 'cuisine',
 	 'price'].include?(sort_order) 
 	...
 	puts "Sort using: 'list cuisinie' or 'list by cuisine'\n\n"
 end
...
def introduction
	...
	puts "This is an interactive guide to help you find
	the food you crave.\n\n"
end
